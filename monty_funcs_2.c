...
/**
 * monty_sub - this subtracts the second value from the top of
 *             a stack_t linked list by the top value.
 * @stack: pointer to the top mode node of a stack_t linked list.
 * @line_number: current working line number(s) of a Monty bytecodes file.
 *
 * Description: a result is stored in the second value node
 *              from the top and the top value is removed.
 */
...
/**
 * monty_mul - it multiplies the second value from the top of
 *             a stack_t linked list by the top value.
 * @stack: pointer to the top mode node of a stack_t linked list.
 * @line_number: current working line number of a Monty bytecodes file.
 *
...
/**
 * monty_mod - this computes the modulus of the second value from the
